...
If the Financial Director deems their situation appropriate, they may grant one of the following from the below list of exceptions and exemptions.
If the Financial Director deems their situation inappropriate for extension, the member may appeal to the Executive Board.
If the Executive Board disagrees with the Financial Director, the Executive Board may grant one of the following from the below list of exceptions and exemptions.
...
\asubsubsection{Possible Exceptions and Exemptions for House Dues}
\begin{enumerate}
	\item The Financial Director or Eboard may provide an extension for payment where deemed appropriate.
	\item The Financial Director or Eboard may provide a prorated plan for payment over time where deemed appropriate.
	\item The Financial Director or Eboard may provide a reduced plan for payment where deemed appropriate. This may be combined with an extension for payment and/or a prorated plan where deemed appropriate.
	\item The Financial Director or Eboard may provide an exemption from payment in cases where it is deemed that it would be too difficult for a member to pay dues even on an extension, a prorated plan, or a reduced plan.
\end{enumerate}
